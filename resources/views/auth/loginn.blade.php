  ...
  <body>
    <div class="uf-form-signin">
      <div class="text-center">
        <a href="https://uifresh.net/"><img src="{{asset('imgs/promostoneLogo.png')}}" alt="" width="80" height="80"></a>
        {{-- <application-logo  /> --}}
      ...
      <form class="mt-4" method="POST" action="{{ route('login') }}">
        <div class="input-group uf-input-group input-group-lg mb-3">
          ...
          <input type="text" name="email" class="form-control" placeholder="Username or Email address" required> 
          @error('email')
